    ...
    <div className="p-4 space-y-4">
      ...
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="item-1">
          <AccordionTrigger className="bg-transparent">What is Vx Traders and how does it work?</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="item-2">
          <AccordionTrigger className="bg-transparent">How do I integrate my Telegram channel with Vx Traders?</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="item-3">
          <AccordionTrigger className="bg-transparent">How can I post my portfolio or trading positions to my Telegram channel?</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="item-4">
          <AccordionTrigger className="bg-transparent">What is the Vx bot standalone mode and how does it benefit me?</AccordionTrigger>
          <AccordionContent>
        ...
        <AccordionItem value="item-5">
          <AccordionTrigger className="bg-transparent">How does the automated posting of top trades work?</AccordionTrigger>
          <AccordionContent>
